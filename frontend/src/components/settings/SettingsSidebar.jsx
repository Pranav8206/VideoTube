...
const SettingsSidebar = ({ activeSection, setActiveSection }) => {
  ...
  return (
    <div className="sticky top-0 h-screen sm:w-44 p-1 sm:p-2 py-5 transition-all duration-300">
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center sm:gap-3 p-2 sm:p-3 rounded-xl text-left transition-all duration-300 justify-center sm:justify-start cursor-pointer ${
                isActive
