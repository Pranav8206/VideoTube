...
const PlaylistCard = memo(
  ({
    ...
    const handleClick = () => navigate(`/p/${playlist._id}`);
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <img
              src={playlist?.videos?.[0]?.thumbnail || "/user.png"}
              alt={playlist.name}
            ...
            >
              <div className="relative">
                <button
                  ...
                  className="sm:w-8 sm:h-8 rounded-full hover:bg-gray-100 flex items-center justify-center"
                ...
                {showOptions && (
                  <div
                    ...
                    } bg-white shadow-lg border border-gray-200 rounded-lg z-10 w-44`}
                    onClick={(e) => {
                      e.stopPropagation();
                    }}
                  >
